...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', help='input file',
                      default='examples/de-ud-train.conllu')
    parser.add_argument('--conll', action='store_true', default=True)
    parser.add_argument('--output', help='output file',
                  default='examples/de-ud-train.conllu.dep')
    ...
    writeDepTree(args.output, sentences)
